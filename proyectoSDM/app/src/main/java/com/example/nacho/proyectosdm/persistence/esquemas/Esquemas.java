...
>>>>>>> cb3da04dc48753f26d437069b1d19351ca265a42
     ...
     public static final String CREAR_TABLA_COMIDA = "CREATE TABLE "+TABLA_COMIDA+" (" +
            ...
            "CELIACO BOOLEAN," +
<<<<<<< HEAD
            "CATEGORIA ENUM('desayuno','comida','merienda','cena'))";

    public static final String CREAR_TABLA_VENDIDOS = "CREATE TABLE "+TABLA_VENDIDOS+" " +
            "(CONSTRAINT ID_COMIDA FOREIGN KEY(ID) REFERENCES PUBLIC.COMIDA(ID), " +
            "CONSTRAINT EMAIL_COMPRADOR FOREIGN KEY(EMAIL) REFERENCES PUBLIC.USUARIO(EMAIL), " +
            "FECHA_VENTA FECHA TIMESTAMP, VALORACION INTEGER)";

    public static final String CREAR_TABLA_MENSAJES = "CREATE TABLE "+TABLA_MENSAJES+" " +
            "(CONSTRAINT ID_CHAT FOREIGN KEY(ID) REFERENCES PUBLIC.CHATS(ID), " +
            "CONSTRAINT EMAIL_EMISOR FOREIGN KEY(EMAIL) REFERENCES PUBLIC.USUARIO(EMAIL), " +
            "MENSAJE VARCHAR(255) NOT NULL, " +
            "FECHA TIMESTAMP)";

    public static final String CREAR_TABLA_CHATS = "CREATE TABLE "+TABLA_CHATS+" " +
            "(ID BIGINT NOT NULL PRIMARY KEY, " +
            "CONSTRAINT EMAIL_USER_1 FOREIGN KEY(EMAIL) REFERENCES PUBLIC.USUARIO(EMAIL), " +
...
=======
    ...
    public static final String CREAR_TABLA_CHATS = "CREATE TABLE "+TABLA_CHATS+" (" +
            "ID BIGINT NOT NULL PRIMARY KEY, " +
            "EMAIL_USER_1 VARCHAR, " +
            "EMAIL_USER_2 VARCHAR, " +
    ...
    public static final String SCRIPT_USUARIOS=
            "INSERT INTO USUARIOS VALUES ('jon@gmail.com','Jon','Gijon','2017-10-16 14:00:00.000000', 'password', true, 638111111);+\n" +
            "INSERT INTO USUARIOS VALUES('sansa@gmail.com','Sansa','Oviedo','2017-10-16 14:00:00.000000', 'password', true, 638222222);\n"+
            "INSERT INTO USUARIOS VALUES('bran@gmail.com','Bran','Gijon','2017-10-16 14:00:00.000000', 'password', true, 638333333);\n" +
            "INSERT INTO USUARIOS VALUES('aria@gmail.com','Aria','Oviedo','2017-10-16 14:00:00.000000', 'password', true, 638444444);";
